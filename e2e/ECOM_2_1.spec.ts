...
test('TC-E2E-ECOM-001: End-to-End Purchase Flow for High-Value Products', async ({ page }) => {
   ...
   await page.locator('input[name="attribute_1"]').first().check();

   // 13. Add to cart and verify counter (Create)
   ...
   // const jewelry = await selectProductByPrice(page, 900)
   // expect(jewelry).not.toBeNull();
   // expect(jewelry!.price).toBeGreaterThan(900);
